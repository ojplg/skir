...
LIB_PATH=$LIB_PATH:$LIBS_DIR/$SERVLET_JAR
LIB_PATH=$LIB_PATH:$LIBS_DIR/$JETLANG_JAR
LIB_PATH=$LIB_PATH:$LIBS_DIR/$WEBSOCKET_JAR
LIB_PATH=$LIB_PATH:$LIBS_DIR/$VELOCITY_JAR
LIB_PATH=$LIB_PATH:$LIBS_DIR/$APACHE_COLLECTIONS_JAR
LIB_PATH=$LIB_PATH:$LIBS_DIR/$APACHE_LANG_JAR.jar
