...
public class StandardMap extends WorldMap {
    ...
    private static final Neighborhood[] graph = new Neighborhood[]{
            ...
            set(Country.Northwest_Territory, Country.Greenland, Country.Ontario, Country.Alberta, Country.Alaska),
            ...
            set(Country.Quebec, Country.Greenland, Country.Eastern_United_States, Country.Ontario),
