...
public class RandomRollerTest {
    ...
    private void runExpectationsDifferenceTest(int numberOfTests, int attackingDiceCount, int defendingDiceCount){
        ...
        assertEquals("Problem with " + attackingDiceCount + " v " + defendingDiceCount + " allowable slack " + allowableAmountOff,
                0, accumulatedDifferenceFromAttackerExpectations, allowableAmountOff);
        assertEquals("Problem with " + attackingDiceCount + " v " + defendingDiceCount + " allowable slack " + allowableAmountOff,
                0, accumulatedDifferenceFromDefenderExpectations, allowableAmountOff);
